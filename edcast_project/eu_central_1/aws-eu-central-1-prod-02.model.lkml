...
include: "/edcast_project/eu_central_1/cf_0_latest_user_details_vw_1.view.lkml"

include: "/edcast_project/eu_central_1/custom_fields_Mylo_100074.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_Tetrapaktraining_100067.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_hkex_100086.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_ned_bank_100081.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_wiseup_100105.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_Nationwide_100121.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_hmgroup_100143.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_sulzer_100116.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_greenhouse_100080.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_ubs_100128.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_woolworth_100145.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_mlh_connect_100092.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_asml_100123.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_tetrapak_100058.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_Pursuit(Manulife)_100104.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_Danone_100001.view.lkml"
include: "/edcast_project/eu_central_1/custom_fields_Hydro_Quebec_100111.view.lkml"


#Content  Explores for Pursuit customer

explore: top_20_content_vw {
  label: "User Analytics - Top 20 Content"
  view_label: "User Analytics Top 20 Content"
  persist_for: "1 hour"

#joining refinement view to get custom attributes for individual customer

  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${top_20_content_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${se1_searches_search_user_details.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${ch2_channel_performance_part2_final_results_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore: u3_users_user_metrics_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_user_metrics_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore: user_card_performance_reporting_i_v {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${user_card_performance_reporting_i_v.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore:  u1_users_latest_metadata_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u1_users_latest_metadata_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore: u2_users_skills_learninggoals_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_skills_learninggoals_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
explore: u3_overall_onboarding_status_part4_final_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_overall_onboarding_status_part4_final_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore: u0_usercards_event_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u0_usercards_event_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore:u2_users_lxp_roles_vw  {
  ...
  join: cf_0_latest_user_details_vw_1{
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_lxp_roles_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore:u2_users_performance_part5_final_results_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_performance_part5_final_results_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore:u3_users_structured_content_performance_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_structured_content_performance_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_channel_performance_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_assignment_status_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_search_user_details_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_skills_learninggoals_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_performance_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_overall_onboarding_status_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore:u2_users_assignment_status_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_assignment_status_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore: g3_groups_structured_content_performance_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_structured_content_performance_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
...
explore: g3_groups_structured_journey_progression_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_structured_journey_progression_data_explorer_vw.user_id_1}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
...
explore: g3_groups_structured_pathway_progression_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_structured_pathway_progression_data_explorer_vw.user_id_1}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore: g4_groups_structured_journey_progression_overview_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g4_groups_structured_journey_progression_overview_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore: g4_groups_structured_pathway_progression_overview_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g4_groups_structured_pathway_progression_overview_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore: u3_users_user_funnel_data_explorer_vw{
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_user_funnel_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_1{
    type: left_outer
    relationship: many_to_one
    sql_on: ${u1_users_skills_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${clc_2_0_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
explore: u3_users_adoption_details_vw {
  ...
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_adoption_details_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u1_users_live_event_cards_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_quiz_data_explorer_part3_final_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_scorm_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_quiz_and_poll_responses_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${leaderboard_data_part2_final_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_1 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${leaderboard_user_agg_score_vw.user_id}=${cf_0_latest_user_details_vw_1.user_id} ;;
  }
