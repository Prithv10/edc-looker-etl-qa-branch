...
include: "/edcast_project/south_east_2/cf_0_latest_user_details_vw_4.view.lkml"


include: "/edcast_project/south_east_2/custom_fields_NSW_600018.view.lkml"
include: "/edcast_project/south_east_2/custom_fields_bendigo_600016.view.lkml"
include: "/edcast_project/south_east_2/custom_fields_LEXI_SRO_600003.view.lkml"
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${se1_searches_search_user_details.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${ch2_channel_performance_part2_final_results_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore: u3_users_user_metrics_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_user_metrics_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore: user_card_performance_reporting_i_v {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${user_card_performance_reporting_i_v.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore:  u1_users_latest_metadata_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u1_users_latest_metadata_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore: u2_users_skills_learninggoals_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_skills_learninggoals_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
explore: u3_overall_onboarding_status_part4_final_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_overall_onboarding_status_part4_final_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore: u0_usercards_event_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u0_usercards_event_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore:u2_users_lxp_roles_vw  {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_lxp_roles_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore:u2_users_performance_part5_final_results_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_performance_part5_final_results_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore:u3_users_structured_content_performance_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_structured_content_performance_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_channel_performance_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_assignment_status_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_search_user_details_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_skills_learninggoals_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_performance_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_overall_onboarding_status_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore:u2_users_assignment_status_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_assignment_status_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore: g3_groups_structured_content_performance_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_structured_content_performance_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
...
explore: g3_groups_structured_journey_progression_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_structured_journey_progression_data_explorer_vw.user_id_1}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
...
explore: g3_groups_structured_pathway_progression_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_structured_pathway_progression_data_explorer_vw.user_id_1}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore: g4_groups_structured_journey_progression_overview_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g4_groups_structured_journey_progression_overview_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore: g4_groups_structured_pathway_progression_overview_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g4_groups_structured_pathway_progression_overview_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore: u3_users_user_funnel_data_explorer_vw{
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_user_funnel_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u1_users_skills_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${clc_2_0_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
explore: u3_users_adoption_details_vw {
  ...
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_adoption_details_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u1_users_live_event_cards_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_quiz_data_explorer_part3_final_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_scorm_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_quiz_and_poll_responses_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${leaderboard_data_part2_final_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_4 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${leaderboard_user_agg_score_vw.user_id}=${cf_0_latest_user_details_vw_4.user_id} ;;
  }
