...
include: "/edcast_project/us_east_1/chritus_views/*.view.lkml"


include: "/edcast_project/us_east_1/cf_0_latest_user_details_vw_3.view.lkml"


include: "/edcast_project/us_east_1/custom_fields_Tally_2102.view.lkml"
include: "/edcast_project/us_east_1/custom_fields_christus_1998.view.lkml"
include: "/edcast_project/us_east_1/custom_fields_exxon_mobile_1949.view.lkml"
include: "/edcast_project/us_east_1/custom_fields_nse_1985.view.lkml"
include: "/edcast_project/us_east_1/custom_fields_Learning_Collective_ICONIC_2073.view.lkml"
include: "/edcast_project/us_east_1/custom_fields_American_Family_Insurance_2014.view.lkml"
include: "/edcast_project/us_east_1/custom_fields_WNS_Glint_2115.view.lkml"
include: "/edcast_project/us_east_1/custom_fields_SchWab_1903.view.lkml"
include: "/edcast_project/us_east_1/custom_fields_SalesU_2155.view.lkml"
include: "/edcast_project/us_east_1/custom_fields_ABG_1603.view.lkml"
...
#Content  Explores for Schwab customer

explore: ch0_channel_core_event_vw{
  label: "Channel Analytics - Events"
  view_label: "Channel Analytics - Channel Events"
  persist_for: "1 hour"

#joining refinement view to get custom attributes for individual customer

  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${ch0_channel_core_event_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore: c_ip_00_master_assignment_dataset_vw
{
  label: "Master Assignment Details"
  group_label: "Christus Health"
  view_label: "Master Assignment"
  persist_for: "1 hour"
}

explore: c_ip_00_master_card_dataset_vw
{
  label: "Master Card Details"
  group_label: "Christus Health"
  view_label: "Master Card Details"
  persist_for: "1 hour"
}

explore: c_ip_00_master_transcript_interactions_vw
{
  label: "Master Transcript Interactions"
  group_label: "Christus Health"
  view_label: "Master Card Details"
  persist_for: "1 hour"
}

explore: c_ip_21_channel_activity_counts_vw
{
...
explore: c_ip_50_user_individual_activity_counts_part1_vw
{
  label: "User Individual Activity"
  group_label: "Christus Health"
  view_label: "Master Card Details"
  persist_for: "1 hour"
}
...
explore: c_ip_60_journey_list_child_cards_interactions_vw
{
  label: "Journey List Child Cards Interactions"
  group_label: "Christus Health"
  view_label: "Master Card Details"
  persist_for: "1 hour"
}

explore: c_ip_70_pathway_list_child_cards_interactions_vw
{
  label: "Pathway List Child Cards Interactions"
  group_label: "Christus Health"
  view_label: "Master Card Details"
  persist_for: "1 hour"
}

explore: c_op_00_master_group_dataset_vw
{
  label: "Master Group Details"
  group_label: "Christus Health"
  view_label: "Master Card Details"
  persist_for: "1 hour"
}

explore: c_op_20_channel_card_listing_vw
{
  label: "Channel Card Details"
  group_label: "Christus Health"
  view_label: "Master Card Details"
  persist_for: "1 hour"
}

explore: c_op_22_channel_followersvisitor_listing_dates_vw
{
  label: "Channel Followers Visitor Details"
  group_label: "Christus Health"
  view_label: "Master Card Details"
  persist_for: "1 hour"
}

explore: c_op_30_comment_comments_w_no_completes_vw
{
  label: "Comments"
  group_label: "Christus Health"
  view_label: "Master Card Details"
...
explore: c_op_60_journey_list_cards_in_journey_vw
{
  label: "Journey List Cards"
  group_label: "Christus Health"
  view_label: "Master Card Details"
  persist_for: "1 hour"
}

explore: c_op_70_pathway_list_child_cards_in_pathway_vw
{
  label: "Pathway List Child Cards"
  group_label: "Christus Health"
  view_label: "Master Card Details"
  persist_for: "1 hour"
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${se1_searches_search_user_details.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${ch2_channel_performance_part2_final_results_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore: u3_users_user_metrics_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_user_metrics_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore: user_card_performance_reporting_i_v {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${user_card_performance_reporting_i_v.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore:  u1_users_latest_metadata_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u1_users_latest_metadata_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore: u2_users_skills_learninggoals_vw {
 ...
 # joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_skills_learninggoals_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
...
explore: u3_overall_onboarding_status_part4_final_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_overall_onboarding_status_part4_final_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore: u0_usercards_event_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u0_usercards_event_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore:u2_users_lxp_roles_vw  {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_lxp_roles_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore:u2_users_performance_part5_final_results_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_performance_part5_final_results_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
...
explore:u3_users_structured_content_performance_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_structured_content_performance_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}

#Group Analytics Explores-------------------

explore:g4_groups_leaderadmin_access_group_performance_data_explorer_vw {
  label: "Group Analytics - Leaderadmin Performance Data Explorer "
  view_label: "Group Leaderadmin Performance Data Explorer"
  persist_for: "1 hour"
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g4_groups_leaderadmin_access_group_performance_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_channel_performance_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_assignment_status_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_search_user_details_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_skills_learninggoals_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_performance_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_overall_onboarding_status_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore:u2_users_assignment_status_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_assignment_status_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore: g3_groups_structured_content_performance_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_structured_content_performance_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
...
explore: g3_groups_structured_journey_progression_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_structured_journey_progression_data_explorer_vw.user_id_1}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
...
explore: g3_groups_structured_pathway_progression_data_explorer_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g3_groups_structured_pathway_progression_data_explorer_vw.user_id_1}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore: g4_groups_structured_journey_progression_overview_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g4_groups_structured_journey_progression_overview_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore: g4_groups_structured_pathway_progression_overview_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${g4_groups_structured_pathway_progression_overview_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore: u3_users_user_funnel_data_explorer_vw{
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_user_funnel_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u1_users_skills_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${clc_2_0_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
explore: u3_users_adoption_details_vw {
  ...
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u3_users_adoption_details_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u1_users_live_event_cards_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_quiz_data_explorer_part3_final_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_scorm_data_explorer_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${u2_users_quiz_and_poll_responses_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${leaderboard_data_part2_final_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
}
...
#joining refinement view to get custom attributes for individual customer
  join: cf_0_latest_user_details_vw_3 {
    type: left_outer
    relationship: many_to_one
    sql_on: ${leaderboard_user_agg_score_vw.user_id}=${cf_0_latest_user_details_vw_3.user_id} ;;
  }
