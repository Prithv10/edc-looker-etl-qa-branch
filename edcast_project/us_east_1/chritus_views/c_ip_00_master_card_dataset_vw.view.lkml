# The name of this view in Looker is "C IP 00 Master Card Dataset Vw"
view: c_ip_00_master_card_dataset_vw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `aws-us-east-1-prod-01.edc_prod_analytics_customer_1998.c_ip_00_master_card_dataset_vw`
    ;;
  ...
  # This dimension will be called "Activity Type" in Explore.
