# The name of this view in Looker is "C IP 50 User Individual Activity Counts Part1 Vw"
view: c_ip_50_user_individual_activity_counts_part1_vw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `aws-us-east-1-prod-01.edc_prod_analytics_customer_1998.c_ip_50_user_individual_activity_counts_part1_vw`
    ;;
  ...
  dimension: badges_completed {
    type: number
    sql: ${TABLE}.badges_completed ;;
  }
  ...
  measure: total_badges_completed {
    type: sum
    sql: ${badges_completed} ;;
  }

  measure: average_badges_completed {
    type: average
    sql: ${badges_completed} ;;
  }
  ...
  dimension: cards_created {
    type: number
    sql: ${TABLE}.cards_created ;;
  }
