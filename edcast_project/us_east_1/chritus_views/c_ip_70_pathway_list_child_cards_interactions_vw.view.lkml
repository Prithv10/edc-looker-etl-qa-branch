# The name of this view in Looker is "C IP 70 Pathway List Child Cards Interactions Vw"
view: c_ip_70_pathway_list_child_cards_interactions_vw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `aws-us-east-1-prod-01.edc_prod_analytics_customer_1998.c_ip_70_pathway_list_child_cards_interactions_vw`
    ;;
