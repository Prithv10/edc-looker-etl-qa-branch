# The name of this view in Looker is "C Op 20 Channel Card Listing Vw"
view: c_op_20_channel_card_listing_vw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `aws-us-east-1-prod-01.edc_prod_analytics_customer_1998.c_op_20_channel_card_listing_vw`
    ;;
