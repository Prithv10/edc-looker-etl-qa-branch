# The name of this view in Looker is "C Op 22 Channel Followersvisitor Listing Dates Vw"
view: c_op_22_channel_followersvisitor_listing_dates_vw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `aws-us-east-1-prod-01.edc_prod_analytics_customer_1998.c_op_22_channel_followersvisitor_listing_dates_vw`
    ;;
  ...
  dimension_group: channel_first_visited {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.channel_first_visited_date ;;
  }

  dimension_group: channel_followed_date {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.channel_followed_date ;;
  }
  ...
  dimension_group: channel_last_visited {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.channel_last_visited_date ;;
  }
  ...
  dimension_group: group_channel_followed {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.group_channel_followed_date ;;
  }
