# The name of this view in Looker is "C Op 70 Pathway List Child Cards In Pathway Vw"
view: c_op_70_pathway_list_child_cards_in_pathway_vw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `aws-us-east-1-prod-01.edc_prod_analytics_customer_1998.c_op_70_pathway_list_child_cards_in_pathway_vw`
    ;;
  ...
  dimension: child_card_id {
    type: number
    sql: ${TABLE}.child_card_id ;;
  }
