...
measure: card_count {
  ...
  set: details {
    fields: [standard_card_type, card_id,card_resource_url,card_state,card_subtype,card_type,ecl_id,
      ecl_source_name,is_card_promoted,is_live_stream,is_public_,is_user_generated,content_structure,card_author_id,
      content_status,card_author_full_name,duration__seconds_,duration__hh_mm_,published_raw,created_raw,
      updated_raw,card_level,average_rating,current_content_owner_full_name,card_title]
  }
