# The name of this view in Looker is "Mock G3 Groups Assignment Status"
view: mock_g3_groups_assignment_status {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gcp-us-central-1-qa-04-323821.spark_edcast_qa.mock_g3_groups_assignment_status`
    ;;
  ...
  set: detail {
    fields: [
      ...
      card_author_id,
      content_status,
      time_group__assignment_created_time,
      assignor_full_name,
      assignor_id,
      group_id,
      assignment_type,
