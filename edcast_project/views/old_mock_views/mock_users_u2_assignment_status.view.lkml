...
view: mock_users_u2_assignment_status {
 ...
 # sql_table_name: `{{ _user_attributes['database'] }}.spark_edcast_qa.mock_users_u2_assignment_status`
  ...
  set: detail {
    fields: [user_id,user_full_name,email,assignor_id, assignment_state,time_assignment_started_raw,time_completed_raw,assignment_due_raw,
      time_assignment_created_raw,assignor_full_name,card_id,card_state,card_title,card_type,is_user_generated,content_structure,card_author_id,
      card_author_full_name,card_resource_url,is_live_stream,card_subtype,ecl_id,ecl_source_name,is_card_promoted,
      #is_public,
      content_status,duration__seconds_,duration__hh_mm_,user_account_status,excluded_from_leaderboard,card_level,average_rating,standard_card_type,
      published_raw,external_id,current_content_owner_full_name,assignment_type ]
  }
}
