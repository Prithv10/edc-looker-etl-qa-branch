# The name of this view in Looker is "G3 Groups Structured Pathway Progression Data Explorer Vw"
view: g3_groups_structured_pathway_progression_data_explorer_vw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.

# sql_table_name: `gcp-us-central-1-qa-04-323821.spark_edcast_qa.g3_groups_structured_pathway_progression_data_explorer_vw`
#     ;;

  sql_table_name: `{{_user_attributes['database']}}.g3_groups_structured_pathway_progression_data_explorer_vw`
  ;;
...
#Custom measure : Total PathwaysCOUNT(DISTINCT `Pathway Title`)
 measure: total_pathways {
    type: count_distinct
    sql: ${TABLE}.pathway_title ;;
    drill_fields: [detail*]
}
  ...
  set: detail {
    fields: [group_name,
      ...
      duration_seconds,
      email,
      pathway_id,card_id,group_id,
      group_status,content_structure,
      pathway_badge_title,card_type,
      user_id_1,badge_content,
      journey_content,pathway_content,
      journey_pathway_content,channel_id,
      is_carousel_enabled,
      channel_content,carousel_content,channel_content_exclusivity,
      pathway_state,
      total_channel_associations,
      #content_status,
      card_author_full_name,card_author_id,
      #is_user_generated,
      card_state,overall_content_structure,overall_content_structure_title,
      overall_content_structure_status,
      overall_content_structure_id,
      excluded_from_leaderboard,user_account_status,
      card_resource_url,
      #is_live_stream,
      is_public,card_subtype,
      ecl_source_name,
      #is_card_promoted,
      card_level,
      average_rating,external_id
