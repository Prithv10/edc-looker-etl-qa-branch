# The name of this view in Looker is "User Card Performance Reporting I V"
view: user_card_performance_reporting_i_v {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gcp-us-central-1-qa-04-323821.edc_qa_analytics_customer_100006.user_card_performance_reporting_i_v`
    ;;
  ...
  dimension: assignment_due_at {
    type: string
    sql: ${TABLE}.assignment_due_at ;;
  }
